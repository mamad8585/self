...
local function kick_ban_res(extra, success, result)
      ...
      elseif get_cmd == 'ban' then
        ...
        send_large_msg(receiver, '✅انجام شد\n⛔️کاربر @'..member..'  با شناسه ['..member_id..'] بن شد')
		ban_user(member_id, chat_id)
      elseif get_cmd == 'unban' then
        send_large_msg(receiver, '✅انجام شد\n✅کاربر @'..member..'  با شناسه ['..member_id..'] از لیست بن پاک شد')
        local hash =  'banned:'..chat_id
        redis:srem(hash, member_id)
        return 'User '..user_id..' unbanned'
      elseif get_cmd == 'banall' then
        send_large_msg(receiver, '✅انجام شد\n⛔️کاربر @'..member..'  با شناسه ['..member_id..'] از لیست بن همه گروه ها پاک شد شد')
		banall_user(member_id)
      elseif get_cmd == 'unbanall' then
        send_large_msg(receiver, '✅انجام شد\n✅کاربر @'..member..'  با شناسه ['..member_id..'] از لیست بن همه گروه ها پاک شد')
