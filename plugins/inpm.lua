...
local service = msg.service
	if to == 'user' and msg.fwd_from then
		...
		text = "Info From <code>Forward</code.\n\nID: "..from_id.."\nFirst: "..from_first_name.."\nLast: "..from_last_name.."\nUsername: "..from_username
...
local function chat_list(msg)
    ...
    local message = 'List of <code>Groups</code>:\nSend <code>/Join</code> To Join!\n\n'
...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "<code>Welcome To Hidden Bot!\nI Am A Cli Robot Based On <code>TeleSeed</code> & Created By <code>Allwen Team</code>\n<code>Our Channles</code>\n@AllwenOficiall\n@TeleShoter:"
     	return text
    end
