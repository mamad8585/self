...
local function run(msg,matches)
    ...
    if matches[1] == "setbotphoto" then
    	...
    	return 'عکس جدید بوت رو بفرست ✅'
    end
    if matches[1] == "خواندن پیام ها" then
    	if matches[2] == "روشن" then
    		redis:set("bot:markread", "on")
    		return "من پیام های شما را میخوانم ✅"
    	end
    	if matches[2] == "خاموش" then
    		redis:del("bot:markread")
    		return "من دیگر پیام ها را نمیخوانم ❎"
    	end
    	return
    end
    ...
    if matches[1] == "contactlist" then
      ...
      return "🈁من به شما لیست مخاطبانم را به 2 فرمت ارسال کردم"
    end
   ...
   return "کاربر با شماره  +"..matches[2].." ذخیره شد"
end
 ...
 if matches[1] == "mycontact" and is_sudo(msg) then
	...
	if matches[1] == 'بازنگری' or matches[1] == "reload" and is_sudo(msg) then
